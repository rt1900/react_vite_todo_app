...
//        val loginResponse = restTemplate.postForEntity(loginUrl, loginRequest, ResponseEntity::class.java)
//        assertEquals(HttpStatus.OK, loginResponse.statusCode)
//
//        // Extract the Authorization token from the login response
//        val authToken = loginResponse.headers["Authorization"]?.get(0)
...
//        assertEquals(HttpStatus.OK, deleteNoteResponse.statusCode)
//
